...
$cotacao_dolar = !empty($data_dolar["USDBRL"]) ? $data_dolar["USDBRL"]["bid"] : null;
...
$cotacao_euro = !empty($data_euro["EURBRL"]) ? $data_euro["EURBRL"]["bid"] : null;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    } elseif ($valor_investido > 0 && $valor_unitario > 0) {
        $quantidade = $valor_investido / $valor_unitario;
    }
...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/style-acoes.css?v=9">
</head>
<body>
        ...
        <div class="acoes-container">
            ...
            <div class="card-cadastro">
                ...
                <form class="form-acoes" method="POST">
                    <!-- Compra ou Venda -->
                    <div class="acao-tabs">
                        <label><input type="radio" name="acao" value="compra" checked> Compra</label>
                        <label><input type="radio" name="acao" value="venda"> Venda</label>
                    </div>

                    <!-- Campos -->
                    <input type="text" name="ticker" placeholder="Ticker (ex: AAPL, MSFT)" required>
                    <input type="number" step="0.01" name="valor_unitario" placeholder="Valor da ação hoje (US$)" required>
                    
                    <br><br>

                    <input type="number" step="0.0001" name="quantidade" placeholder="Quantidade (ex: 2.75)">
                    <input type="number" step="0.01" name="valor_investido" placeholder="Valor estimado (US$)">
